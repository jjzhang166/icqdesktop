...
namespace HistoryControl
{
    ...
    void PttAudioWidget::initialize()
    {
        ...
        MetaDownloadId_ = Ui::GetDispatcher()->downloadSharedFile(
            Contact_,
            Uri_,
    ...
    void PttAudioWidget::render(QPainter &p)
    {
        ...
        p.drawPixmap(Ui::MessageStyle::getBubbleHorPadding(), Utils::scale_value(play_button_top_margin), pixmap);
        ...
        if (AudioState_ == ptt_audio_downloading)
        {
            ...
            p.drawArc(QRect(Ui::MessageStyle::getBubbleHorPadding() + penWidth / 2, Utils::scale_value(play_button_top_margin) + penWidth / 2, pixmap.width() / ratio - penWidth, pixmap.height() / ratio - penWidth), -baseAngle, -angle);
        }
        ...
        if (TextDownloading_)
        {
            ...
            const auto baseAngle = (AngleValue_ * 16);
            p.drawArc(QRect(width() - Ui::MessageStyle::getBubbleHorPadding() - Utils::scale_value(text_button_size) + penWidth / 2, Utils::scale_value(text_button_top_margin) + penWidth / 2,
        ...
        else
        {
            ...
            Utils::check_pixel_ratio(pixmap);
            p.drawPixmap(width() - Ui::MessageStyle::getBubbleHorPadding() - pixmap.width() / ratio, Utils::scale_value(text_button_top_margin), pixmap);
        }
        ...
        if (HaveText_)
        {
            ...
            PttText_->render(&p, QPoint(Ui::MessageStyle::getBubbleHorPadding(), Utils::scale_value(widget_height) + Utils::scale_value(text_top_margin)));
        }
    ...
    bool PttAudioWidget::selectByPos(const QPoint &p)
    {
       ...
       if (!isSelected())
       {
           ...
           pos.setX(pos.x() - Ui::MessageStyle::getBubbleHorPadding());
    ...
    void PttAudioWidget::messageDownloadError(qint64 id, QString, qint32)
    {
        if (id == DownloadId_)
        {
            DownloadId_ = Ui::GetDispatcher()->downloadSharedFile(
                Contact_,
                Uri_,
                Ui::get_gui_settings()->get_value<QString>(settings_download_directory, Utils::DefaultDownloadsPath()),
                QString(),
    ...
    {
        return pos.x() >= Ui::MessageStyle::getBubbleHorPadding() && pos.x() <= Utils::scale_value(play_button_size) + Ui::MessageStyle::getBubbleHorPadding()
    ...
    {
        return pos.x() >= width() - Ui::MessageStyle::getBubbleHorPadding() - Utils::scale_value(text_button_size)
               && pos.x() <= width() - Ui::MessageStyle::getBubbleHorPadding()
