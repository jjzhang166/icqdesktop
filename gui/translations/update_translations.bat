%QTPATH%\bin\lupdate.exe .. -ts en.ts -noobsolete -source-language en -target-language en -locations none
%QTPATH%\bin\lupdate.exe .. -ts ru.ts -noobsolete -source-language en -target-language ru -locations none
%QTPATH%\bin\lupdate.exe .. -ts de.ts -noobsolete -source-language en -target-language de -locations none
