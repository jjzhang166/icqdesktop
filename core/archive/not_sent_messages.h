...
namespace core
{
    ...
    namespace archive
    {
        ...
        private:
            ...
            not_sent_message(const not_sent_message_sptr& _message, const std::string& _wimid, const uint64_t _time);
        ...
        public:
            ...
            not_sent_message_sptr get_by_iid(const std::string& _iid) const;
