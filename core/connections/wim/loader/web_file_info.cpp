...
void web_file_info::set_file_url(const std::string& _url)
{
    file_url_ = _url;
}
...
void web_file_info::set_file_name(const std::wstring& _name)
{
    file_name_ = _name;
}
...
void web_file_info::set_file_dlink(const std::string& _dlink)
{
    file_dlink_ = _dlink;
}
...
void web_file_info::set_mime(const std::string& _mime)
{
    mime_ = _mime;
}
...
void web_file_info::set_md5(const std::string& _md5)
{
    md5_ = _md5;
}
...
void web_file_info::set_file_preview(const std::string& _val)
{
    file_preview_ = _val;
}
...
void web_file_info::set_file_preview_2k(const std::string& _val)
{
...
void web_file_info::set_file_id(const std::string& _file_id)
{
    file_id_ = _file_id;
}

void web_file_info::set_file_name_short(const std::string& _file_name_short)
{
